...
# ======= build model, optimizer, and define loss func ======= #
...
# If a pre-trained ResNet is required, load the weights. This must be done AFTER the variables are initialized with sess.run()
